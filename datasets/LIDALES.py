...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Class handling LIDALES dataset.
...
class LIDALESDataset(PointCloudDataset):
    """Class to handle LIDALES dataset."""

    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        """
        This dataset is small enough to be stored in-memory, so load all point clouds here
        """
        PointCloudDataset.__init__(self, 'LIDALES')
        ...
        if self.set == 'training':
            ...
            raise ValueError('Unknown set for LIDALES data: ', self.set)
        ...
        train_names, test_names = self.prepare_LIDALES_ply()
    ...
    def prepare_LIDALES_ply(self, from_txt=False):
        """
...
class LIDALESSampler(Sampler):
    """Sampler for LIDALES"""

    def __init__(self, dataset: LIDALESDataset):
...
class LIDALESCustomBatch:
    """Custom batch definition with memory pinning for LIDALES"""
...
def LIDALESCollate(batch_data):
    return LIDALESCustomBatch(batch_data)
